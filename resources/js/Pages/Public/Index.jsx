						...
						<div className="container">
							<div className="row align-items-center justify-content-xl-between g-4 g-md-5">
								...
								<div className="col-lg-5 col-xl-6 text-center position-relative">
									...
									{/* Live class */}
									<div className="p-3 bg-body shadow rounded-4 position-absolute top-0 start-0 translate-middle ms-5 z-index-1 d-none d-xl-block">
										<div className="d-flex justify-content-between">
											...
											<div className="text-start ms-3">
												...
												{/* Button */}
												<a href="#" className="btn btn-sm btn-danger-soft mt-2 mb-0">
													Join now
												</a>
											</div>
										</div>
									...
									<div className="position-absolute top-100 start-100 translate-middle z-index-1 ms-n6 mt-n5 d-none d-xxl-block">
										<div className="bg-body shadow p-4 rounded-3 d-inline-block position-relative z-index-1">
											{/* Icon */}

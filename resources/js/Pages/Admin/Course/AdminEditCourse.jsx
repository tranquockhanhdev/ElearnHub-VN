// File: resources/js/Pages/Admin/Course/AdminEditCourse.jsx
...
const AdminEditCourse = () => {
    const { auth, course, categories, instructors, flash_error, errors } =
        usePage().props;
    ...
    const [formData, setFormData] = useState({
        ...
        instructor_id: course.instructor_id || auth.user.id,
        course_image: null,
    ...
    const handleSubmit = (e) => {
        ...
        router.post(route("admin.courses.update", course.id), payload, {
            forceFormData: true,
            preserveScroll: true,
        });
    };
    ...
    const storedImageUrl = course.img_url ? `/storage/${course.img_url}` : null;
                                                        ...
                                                        <div className="text-end">
                                                            ...
                                                            <p className="mb-0 small mt-1 text-muted">
                                                                {!hasImage
                                                                    ...
                                                                    : "Khóa học sẽ được kiểm duyệt trước khi xuất bản"}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>

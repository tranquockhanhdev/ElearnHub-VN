      ...
      <div className="page-content-wrapper border">
        ...
        {activeTab === 'grid' && (
          <div className="row g-4">
                ...
                <div className="card bg-transparent border h-100">
                  <div className="card-header bg-transparent border-bottom d-flex justify-content-between">
                    ...
                    <div className="dropdown">
                      <a href="#" className="btn btn-sm btn-light btn-round" data-bs-toggle="dropdown">
                        <i className="bi bi-three-dots fa-fw"></i>
                      </a>
                      <ul className="dropdown-menu dropdown-menu-end shadow rounded">
                        <li>
                          <Link className="dropdown-item" href={`/admin-course/${course.id}/edit`}>
            ...
            {courses.length === 0 && <div className="text-center w-100">No courses found</div>}
          </div>
        )}
                ...
                {courses.map((course) => (
                  <tr key={course.id}>
                    ...
                    <td>
                      ...
                      <a href="#" className="btn btn-sm btn-outline-secondary" title="View">
                        <i className="bi bi-eye-fill"></i>
                      </a>
                    </td>
                  </tr>

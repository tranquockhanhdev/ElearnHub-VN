                            ...
                            <div className="row justify-content-center">
                                <div className="col-lg-8 col-md-10 text-center">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <h4 className="mb-3">
                                            Khóa học của bạn đã được thêm thành
                                            công
                                        </h4>
                                            ...
                                            <div className="col-md-8">
                                                <div className="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div className="text-center">
                                                        <div
                                                            className="bg-success rounded-circle mx-auto mb-2 d-flex align-items-center justify-content-center"
                                                            style={{
                                                                width: "40px",
                                                                height: "40px",
                                                            }}
                                                    ...
                                                    <div className="text-center">
                                                        <div
                                                            className="bg-warning rounded-circle mx-auto mb-2 d-flex align-items-center justify-content-center"
                                                            style={{
                                                                width: "40px",
                                                                height: "40px",
                                                            }}
                                                    ...
                                                    <div className="text-center">
                                                        <div
                                                            className="bg-light border rounded-circle mx-auto mb-2 d-flex align-items-center justify-content-center"
                                                            style={{
                                                                width: "40px",
                                                                height: "40px",
                                                            }}
                                    ...
                                    <div className="mt-5 pt-4 border-top">
                                        <h6 className="text-muted mb-3">
                                            💡 Mẹo để khóa học được duyệt nhanh
                                            hơn:
                                        </h6>
                                        <div className="row text-start">
                                            <div className="col-md-4 mb-3">
                                                <div className="text-center">
                                                    <i
                                                        className="bi bi-image text-primary mb-2"
                                                        style={{
                                                            fontSize: "2rem",
                                                        }}
                                                    ></i>
                                            ...
                                            <div className="col-md-4 mb-3">
                                                <div className="text-center">
                                                    <i
                                                        className="bi bi-file-text text-success mb-2"
                                                        style={{
                                                            fontSize: "2rem",
                                                        }}
                                                    ></i>
                                            ...
                                            <div className="col-md-4 mb-3">
                                                <div className="text-center">
                                                    <i
                                                        className="bi bi-tags text-warning mb-2"
                                                        style={{
                                                            fontSize: "2rem",
                                                        }}
                                                    ></i>

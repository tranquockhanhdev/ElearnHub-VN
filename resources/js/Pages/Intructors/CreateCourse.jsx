...
const CreateCourse = () => {
    const { auth, categories, flash_error, old, errors } = usePage().props;
                        ...
                        <ul className="mb-0">
                            {Object.entries(errors).map(([field, messages]) => (
                                <li key={field}>
                                    <strong>
                                        {field === 'title' ? 'Tiêu đề' :
                                            field === 'category_ids' ? 'Danh mục' :
                                                field === 'price' ? 'Giá' :
                                                    field === 'description' ? 'Mô tả' :
                                                        field === 'course_image' ? 'Hình ảnh' :
                                                            field === 'general' ? 'Chung' : field}:
                                    </strong> {Array.isArray(messages) ? messages.join(', ') : messages}
                                </li>
                            ))}
                        </ul>
                        <button type="button" className="btn-close" data-bs-dismiss="alert"></button>
                ...
                <section>
                    <div className="container">
                        ...
                        <div className="card border rounded-3 mb-5">
                            <div id="stepper" className="bs-stepper stepper-outline" ref={stepperRef}>
                                {/* Stepper Header */}
                                    ...
                                    <div className="bs-stepper-header" role="tablist">
                                        <div className="step" data-target="#step-1">
                                            <div className="d-grid text-center align-items-center">
                                                ...
                                                <h6 className="bs-stepper-label d-none d-md-block">Chi Tiết Khóa học</h6>
                                            </div>
                                        </div>
                                        <div className="line" />
                                        <div className="step" data-target="#step-2">
                                            <div className="d-grid text-center align-items-center">
                                                ...
                                                <h6 className="bs-stepper-label d-none d-md-block">Hình Ảnh Khóa Học <span className="text-danger">*</span></h6>
                                            </div>
                                        </div>
                                        <div className="line" />
                                        <div className="step" data-target="#step-3">
                                            <div className="d-grid text-center align-items-center">
                                                ...
                                                <h6 className="bs-stepper-label d-none d-md-block">Chờ Duyệt</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="bs-stepper-content">
                                        <form onSubmit={handleSubmit}>
                                                ...
                                                <div className="row g-4">
                                                    ...
                                                    <div className="col-12">
                                                        <label className="form-label">
                                                            Danh mục khoá học
                                                            <span className="text-muted">(Chọn một hoặc nhiều danh mục)</span>
                                                        </label>
                                                        ...
                                                        {formData.category_ids?.length > 0 && (
                                                            <div className="mb-3">
                                                                <div className="border rounded p-2 bg-light" style={{ maxHeight: '100px', overflowY: 'auto' }}>
                                                                    <small className="text-muted d-block mb-1">Đã chọn:</small>
                                                        ...
                                                        {errors?.category_ids && (
                                                            <div className="text-danger mt-2">
                                                                <small>
                                                                    ...
                                                                    {Array.isArray(errors.category_ids) ? errors.category_ids[0] : errors.category_ids}
                                                                </small>
                                                            </div>
                                                        )}
                                                    </div>
                                                    ...
                                                    <div className="col-12">
                                                        ...
                                                        <div className="bg-body border rounded-bottom h-400px overflow-hidden" ref={quillRef}></div>
                                            ...
                                            <div id="step-2" role="tabpanel" className="content fade" aria-labelledby="steppertrigger2">
                                                <h4>Hình Ảnh Khóa Học <span className="text-danger">*</span></h4>
                                                <hr />

                                                {errors?.course_image && (
                                                    <div className="alert alert-danger">
                                                        <i className="bi bi-exclamation-triangle me-2"></i>
                                                        <strong>Bắt buộc:</strong> {Array.isArray(errors.course_image) ? errors.course_image[0] : errors.course_image}
                                                    </div>
                                                )}
                                                ...
                                                <div className="row">
                                                        ...
                                                        {!imagePreview ? (
                                                            ...
                                                            >
                                                                ...
                                                                {isUploading ? (
                                                                    ...
                                                                    <div>
                                                                        <i className={`bi bi-cloud-upload fs-1 mb-3 ${errors?.course_image
                                                                            ? 'text-danger'
                                                                            : isDragging ? 'text-primary' : 'text-secondary'
                                                                            }`}></i>
                                                                        <h6 className="my-2">
                                                                            {isDragging ? 'Thả ảnh vào đây' : 'Kéo thả ảnh vào đây hoặc'}
                                                                            {!isDragging && (
                                                                        ...
                                                                        <input className="form-control d-none" type="file" name="course_image"
                                                                        ...
                                                                        <p className="small mb-0 mt-2 text-muted">
                                                                            ...
                                                                            <br /><span className="text-danger"><strong>* Bắt buộc phải có ảnh bìa</strong></span>
                                                                        </p>
                                                                    </div>
                                                                )}
                                                            </div>
                                                                        ...
                                                                        <div className="position-relative">
                                                                            ...
                                                                            <div className="position-absolute top-0 end-0 m-2">
                                                                                <button type="button" className="btn btn-sm btn-danger"
                                                                                    onClick={handleRemoveImage} title="Xóa ảnh">
                                                                    ...
                                                                    <div className="col-md-4">
                                                                        <div className="h-100 d-flex flex-column justify-content-center">
                                                                            ...
                                                                            {formData.course_image && (
                                                                                <div className="mt-3">
                                                                                    <p className="mb-1"><strong>Tên file:</strong> {formData.course_image.name}</p>
                                                                                    <p className="mb-1"><strong>Kích thước:</strong> {formatFileSize(formData.course_image.size)}</p>
                                                                                    <p className="mb-1"><strong>Loại:</strong> {formData.course_image.type}</p>
                                                                                </div>
                                                                            )}
                                                                            ...
                                                                            <div className="mt-3">
                                                                                ...
                                                                                <input className="form-control d-none" type="file"
                                                                                    id="image-replace" accept="image/gif, image/jpeg, image/png"
                                                                                    onChange={handleImageChange} />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div className="col-12 mt-4">
                                                        <div className="alert alert-info">
                                                            <h6 className="alert-heading">
                                                                ...
                                                                Hướng dẫn chọn ảnh bìa (Bắt buộc)
                                                            </h6>
                                                            <ul className="mb-0">
                                                                <li><strong>Bắt buộc:</strong> Mỗi khóa học phải có ảnh bìa</li>
                                                    ...
                                                    <div className="d-flex justify-content-between mt-4">
                                                        ...
                                                        <button
                                                            className={`btn next-btn mb-0 ${!formData.course_image ? 'btn-outline-primary' : 'btn-primary'}`}
                                                            disabled={!formData.course_image}
                                                            type="button"
                                                            title={!formData.course_image ? "Vui lòng tải lên ảnh bìa để tiếp tục" : ""}
                                                        >
                                                            {!formData.course_image ? (
                                                                <>
                                                                    <i className="bi bi-exclamation-triangle me-2"></i>
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-12 mb-4">
                                                        <div className="card bg-light">
                                                            <div className="card-body">
                                                                <h6>Tóm tắt khóa học:</h6>
                                                                <ul className="list-unstyled">
                                                                    <li><strong>Tiêu đề:</strong> {formData.title}</li>
                                                                    <li><strong>Danh mục:</strong> {formData.category_ids?.length || 0} danh mục được chọn</li>
                                                                    <li><strong>Giá:</strong> {new Intl.NumberFormat('vi-VN', {
                                                                        style: 'currency',
                                                                        currency: 'VND'
                                                                    }).format(formData.price || 0)}</li>
                                                                    <li><strong>Ảnh bìa:</strong>
                                                                        {formData.course_image ? (
                                                    ...
                                                    <div className="d-flex justify-content-between">
                                                        <button type='button' className="btn btn-secondary prev-btn me-2">
                                                            Previous
                                                        </button>
                                                        <div className="text-end">
                                                            <button
                                                                type="submit"
                                                                className={`btn mb-0 ${!formData.course_image ? 'btn-outline-success' : 'btn-success'}`}
                                                                disabled={!formData.course_image}
                                                                title={!formData.course_image ? "Vui lòng tải lên ảnh bìa trước khi gửi" : ""}
                                                            >
                                                                {!formData.course_image ? (
                                                                    <>
                                                                        <i className="bi bi-exclamation-triangle me-2"></i>
